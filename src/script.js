...
const bushMaterial = new THREE.MeshStandardMaterial({color: '#85c854'})
...
bush2.position.set(1.3,.1,2.1)

const bush3 = new THREE.Mesh(bushGeometry, bushMaterial)
bush3.scale.set(.4, .4, .4)
bush3.position.set(-.7,.1,2.2)
...
const graveMaterial = new THREE.MeshStandardMaterial({color: '#B0B0B0'})
